...
| `st03_zgw_probe.sh` | ST-03, ST-05 | shared mDNS (`avahi-resolve`) probe of the ZGW controller resource. |
...
| `st05_analyze.sh`   | ST-05 | post-run: reuse `st03_zgw_probe.csv`; FAIL on any non-ok row or latency above 5 s |
